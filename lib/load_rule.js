    ...
    _.promise(self)
        ...
        .make(sd => {
            ...
            sd.rules.forEach(rule => {
                rule.title_required = _.is.Nullish(rule.title_required) ? true : !!rule.title_required
                rule.document_required = _.is.Nullish(rule.document_required) ? true : !!rule.document_required
            })
